...
public class NGSIKafkaSink extends NGSISink {
    ...
    public void configure(Context context) {
        ...
        replicationFactor = context.getInteger("replication_factor", 1).shortValue();
    ...
    public void start() {
        ...
        try {
            persistenceBackend = new KafkaBackendImpl(brokerList, batchSize);
...
*/
    ...
    private class KafkaAggregator {
        ...
        protected List<String> aggregation;
        ...
        public void aggregate(NGSIEvent event) {
            ...
            if (aggregation.isEmpty()) {
                aggregation.add(buildMessage(contextElement, service, servicePathForData, recvTimeTs));
            } else {
                aggregation.add(buildMessage(contextElement, service, servicePathForData, recvTimeTs));
            } // if else
        } // aggregate
    ...
    private void persistAggregation(KafkaAggregator aggregator) throws CygnusBadConfiguration, CygnusPersistenceError {
        List<String> aggregation = aggregator.getAggregation();
        ...
        for(String message : aggregation){
